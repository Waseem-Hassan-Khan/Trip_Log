            ...
            modelBuilder.Entity("Trip_Log.Models.TripLogModel", b =>
                {
                    ...
                    b.Property<int>("AccommodationEntityAccommodationId")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("DestinationEntityDestinationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AccommodationEntityAccommodationId");

                    b.HasIndex("DestinationEntityDestinationId");
            ...
            modelBuilder.Entity("Trip_Log.Models.TripLogModel", b =>
                {
                    b.HasOne("DataAccessLayer.Models.Accommodation", "AccommodationEntity")
                        .WithMany("Trips")
                        .HasForeignKey("AccommodationEntityAccommodationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DataAccessLayer.Models.Destination", "DestinationEntity")
                        .WithMany("Trips")
                        .HasForeignKey("DestinationEntityDestinationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
